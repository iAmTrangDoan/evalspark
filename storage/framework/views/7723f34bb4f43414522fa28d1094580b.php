...
<body>
    ...
    <div class="main-wrapper">
      ...
      <aside class="sidebar">
        <nav class="nav flex-column">
          ...
          <a href="<?php echo e(route('groups.create')); ?>" class="nav-link <?php echo e(request()->routeIs('groups.create') ? 'active' : ''); ?>">
          ...
          <a href="<?php echo e(route('groups.index')); ?>" class="nav-link <?php echo e(request()->routeIs('groups.*') && !request()->routeIs('groups.create') ? 'active' : ''); ?>">
             <span class="material-icons-outlined">groups</span>
             Groups
          </a>
          <a href="<?php echo e(route('classes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('classes.*') && !request()->routeIs('classes.join') ? 'active' : ''); ?>">
  ...
  <div class="modal fade" id="joinModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('classes.join')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/layouts/student_dashboard.blade.php ENDPATH**/ ?>