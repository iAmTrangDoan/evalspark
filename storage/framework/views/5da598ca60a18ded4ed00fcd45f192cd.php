...
<body>
        ...
        <div class="dropdown">
           <div class="d-flex align-items-center gap-2 cursor-pointer" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="avatar-circle overflow-hidden" 
                   style="<?php echo e(Auth::user()->avatar_url ? 'background-image: url(' . Auth::user()->avatar_url . '); background-size: cover; background-position: center;' : ''); ?>">
                   <?php echo e(Auth::user()->avatar_url ? '' : substr(Auth::user()->name, 0, 1)); ?>

              </div>
              <div class="d-none d-md-block text-start">
                <div class="fw-bold small" style="line-height: 1.2"><?php echo e(Auth::user()->name); ?></div>
           ...
           <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2">
             <li><a class="dropdown-item small fw-bold d-flex align-items-center gap-2" href="<?php echo e(route('profile.edit')); ?>"><span class="material-icons-outlined fs-6">person</span> Profile</a></li>
    ...
    <div class="main-wrapper">
      ...
      <aside class="sidebar">
        <nav class="nav flex-column">
          <a href="<?php echo e(route('lecturer.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('lecturer.dashboard') ? 'active' : ''); ?>">
          ...
          <a href="<?php echo e(route('classes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('classes.index') && !request()->routeIs('classes.create') ? 'active' : ''); ?>">
            <span class="material-icons-outlined">class</span>
            My Classes
          </a>

          <a href="<?php echo e(route('groups.index')); ?>" class="nav-link <?php echo e(request()->routeIs('groups.*') ? 'active' : ''); ?>">
  ...
  <?php echo $__env->make('classes.partials.create_modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

  <!-- Bootstrap JS -->
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/layouts/lecturer_dashboard.blade.php ENDPATH**/ ?>