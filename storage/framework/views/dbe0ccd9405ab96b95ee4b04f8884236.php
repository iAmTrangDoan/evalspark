                ...
                <div class="card-body">
                    <form action="<?php echo e(route('groups.store')); ?>" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="<?php echo e(route('student.dashboard')); ?>" class="btn btn-light text-secondary fw-bold">Cancel</a>
...
<?php echo $__env->make('layouts.student_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/groups/create.blade.php ENDPATH**/ ?>