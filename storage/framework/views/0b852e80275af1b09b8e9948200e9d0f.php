    ...
    <nav class="navbar navbar-expand-md navbar-light sticky-top">
        <div class="container">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="<?php echo e(route('login')); ?>" class="btn btn-light-custom d-none d-sm-block">Log In</a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-3 hero-btns">
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg px-4">Sign Up for Free</a>
                        </div>
        ...
        <section class="py-5">
            <div class="container">
                <div class="cta-container text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-cta">
                        Get Started Now
...
<?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/welcome.blade.php ENDPATH**/ ?>