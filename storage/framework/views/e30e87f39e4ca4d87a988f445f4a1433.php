...
<div class="container-fluid py-4 px-md-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-2 small fw-medium">
            <li class="breadcrumb-item">
                ...
                <a href="<?php echo e(route('student.dashboard')); ?>" class="text-decoration-none text-muted">Dashboard</a></li>
                <?php else: ?>
                <a href="<?php echo e(route('lecturer.dashboard')); ?>" class="text-decoration-none text-muted">Dashboard</a></li>
                <?php endif; ?>
            </li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('classes.index')); ?>" class="text-decoration-none text-muted"><?php echo e($group->classRoom->name ?? 'Class'); ?></a></li>
    ...
    <div class="row align-items-end mb-5">
        <div class="col-md-7">
            <h1 class="fw-black mb-1 fw-bold"><strong><?php echo e($group->name); ?></strong></h1>
            <p class="text-muted mb-0"><?php echo e($group->description ?? 'No description provided for this group.'); ?></p>
            <div class="mt-3 d-flex align-items-center gap-2">
                <span class="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25">Update</span>
                <span class="text-muted small">| Last updated <?php echo e($group->updated_at ? $group->updated_at->diffForHumans() : 'recently'); ?></span>
            </div>
        </div>
        <div class="col-md-5">  
                ...
                <div class="progress-container flex-grow-1 d-flex flex-column justify-content-center">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div class="text-end">
                            ...
                            <span class="fw-bold text-primary h4 mb-0"><?php echo e($completionPercentage ?? 0); ?>%</span>
                        </div>
                    </div>
                    <div class="progress mb-3" style="height: 8px;">
                        <div class="progress-bar" role="progressbar" style="width: <?php echo e($completionPercentage ?? 0); ?>%;" aria-valuenow="<?php echo e($completionPercentage ?? 0); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
    ...
    <div class="d-flex overflow-auto pb-4" id="board-container">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $group->lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="kanban-column" id="list-<?php echo e($list->id); ?>" draggable="true" ondragstart="drag(event)" ondrop="drop(event)" ondragover="allowDrop(event)" ondragleave="dragLeave(event)">
            <div class="d-flex justify-content-between align-items-center px-2 mb-3 handle">
                <h6 class="fw-bold mb-0 text-uppercase d-flex align-items-center gap-2" style="cursor: pointer;" onclick="editListName(this, <?php echo e($list->id); ?>)">
                    <span class="list-name"><?php echo e($list->name); ?></span> 
                    <span class="badge bg-secondary rounded-pill count-badge"><?php echo e($list->cards->count()); ?></span>
                </h6>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item text-danger small fw-bold" href="#" onclick="deleteList(<?php echo e($list->id); ?>); return false;">Delete List</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="kanban-cards-wrapper custom-scrollbar">
                ...
                <div class="kanban-card" id="card-<?php echo e($card->id); ?>" draggable="true" ondragstart="drag(event)" onclick="onCardClick(this)" data-card="<?php echo e(json_encode($card)); ?>">
                    <?php if($card->label): ?>
                    <span class="badge-custom bg-purple bg-opacity-10 text-info" style="background-color: #f3e8ff; color: #7e22ce;"><?php echo e($card->label); ?></span>
                    <?php endif; ?>
                            ...
                            <!-- Completion Checkbox -->
                             <div class="form-check">
                                <input class="form-check-input rounded-circle border-2" type="checkbox" style="width: 1.2rem; height: 1.2rem; cursor: pointer; border-color: #cbd5e1;" 
                                    onclick="toggleCardCompletion(event, <?php echo e($card->id); ?>, <?php echo e($card->is_completed); ?>, <?php echo e($card->checklists->count()); ?>, <?php echo e($card->progress_percent ?? 0); ?>)"
                                    <?php echo e($card->is_completed ? 'checked' : ''); ?>>
                            </div>
                            <p class="small fw-semibold mb-0 text-break pe-2 <?php echo e($card->is_completed ? 'text-decoration-line-through text-muted' : ''); ?>" id="card-name-<?php echo e($card->id); ?>"><?php echo e($card->name); ?></p>
                        </div>

                        <?php if($card->priority == 1): ?> <span class="small fw-bold text-uppercase priority-high" style="font-size: 0.8rem;">High</span>
                        <?php elseif($card->priority == 2): ?> <span class="small fw-bold text-uppercase priority-medium" style="font-size: 0.8rem;">Medium</span>
                        <?php elseif($card->priority == 3): ?> <span class="small fw-bold text-uppercase priority-low" style="font-size: 0.8rem;">Low</span>
                        <?php endif; ?>
                    </div>
                    
                    <?php if($card->checklists->count() > 0): ?>
                    <div class="progress mb-3" style="height: 4px;">
                        <div class="progress-bar" style="width: <?php echo e($card->progress_percent ?? 0); ?>%;"></div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex gap-2">
                             ...
                             <?php endif; ?>
                             <?php if($card->checklists->count() > 0): ?>
                                <span class="material-symbols-outlined text-muted fs-6" title="Checklist (<?php echo e($card->progress_percent ?? 0); ?>%)">check_box</span>
                             <?php endif; ?>
                        </div>
                        <?php if($card->assignedUser): ?>
                        <div class="avatar-sm" style="background-image: url('<?php echo e($card->assignedUser->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($card->assignedUser->name).'&background=random'); ?>')" title="Assigned to <?php echo e($card->assignedUser->name); ?>"></div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <button class="btn btn-transparent w-100 text-start text-muted btn-sm fw-bold mt-2" onclick="openCreateCardModal(<?php echo e($list->id); ?>)">
            ...
            <div class="modal-body p-4">
                ...
                <div class="card mb-3 border shadow-sm">
                    ...
                    <div class="card-header bg-white d-flex align-items-center justify-content-between p-3" 
                         ...
                         data-bs-target="#collapseMember<?php echo e($member->id); ?>" 
                         aria-expanded="false" 
                         style="cursor: pointer;">
                        
                        <div class="d-flex align-items-center gap-3">
                             <div class="avatar-sm" style="width: 40px; height: 40px; background-image: url('<?php echo e($member->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($member->name).'&background=random'); ?>')"></div>
                             <div>
                                 <h6 class="fw-bold mb-0"><?php echo e($member->name); ?></h6>
                                 <span class="text-primary small fw-semibold"><?php echo e($member->pivot->role); ?></span>
                             </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-4">
                             ...
                             <div class="d-none d-md-block text-end" style="min-width: 100px;">
                                ...
                                ?>
                                <?php if($memberScoreObj): ?>
                                    <div class="small fw-bold text-success mb-1">Score: <?php echo e($memberScoreObj->score); ?>/10</div>
                                <?php endif; ?>
                                <div class="small fw-bold <?php echo e($percent == 100 ? 'text-success' : 'text-secondary'); ?>"><?php echo e($percent); ?>% Done</div>
                                <div class="progress mt-1" style="height: 5px;">
                                    <div class="progress-bar <?php echo e($percent == 100 ? 'bg-success' : 'bg-primary'); ?>" style="width: <?php echo e($percent); ?>%;"></div>
                                </div>
                             </div>
                             


                             <?php if($group->leader_id == auth()->id() && $member->id != auth()->id()): ?>
                                <form action="<?php echo e(route('groups.transfer_leadership', $group->id)); ?>" method="POST" onclick="event.stopPropagation();" onsubmit="return confirm('Transfer leadership to <?php echo e($member->name); ?>?');">
                                    <?php echo csrf_field(); ?>
                    ...
                    <!-- Collapsible Content -->
                    <div class="collapse" id="collapseMember<?php echo e($member->id); ?>">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 border-end">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end mb-3">
                                        <div>
                                            <span class="display-6 fw-bold"><?php echo e($percent); ?>%</span>
                                            <span class="d-block small text-muted">Tasks Completed</span>
                                        </div>
                                        <div class="text-end">
                                            <span class="h5 fw-bold mb-0"><?php echo e($completedAssigned); ?> / <?php echo e($totalAssigned); ?></span>
                                    ...
                                    <form action="<?php echo e(route('grades.store')); ?>" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="grades[<?php echo e($member->id); ?>][score]" class="form-control fw-bold" step="0.1" min="0" max="10" 
                                                    value="<?php echo e($scoreObj ? $scoreObj->score : ''); ?>" 
                                                    placeholder="<?php echo e($scoreObj ? '' : 'Not graded yet'); ?>" 
                                                    <?php echo e(($isLecturer && !$group->is_graded) ? '' : 'disabled'); ?>>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="grades[<?php echo e($member->id); ?>][feedback]" class="form-control" rows="3" 
                                                placeholder="<?php echo e($scoreObj && $scoreObj->comment ? '' : 'No feedback yet'); ?>" 
                                                <?php echo e(($isLecturer && !$group->is_graded) ? '' : 'disabled'); ?>><?php echo e($scoreObj ? $scoreObj->comment : ''); ?></textarea>
                                        </div>

                                        <?php if($isLecturer): ?>
                                            <?php if(!$group->is_graded): ?>
                                                <div class="d-flex gap-2">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <button type="submit" formaction="<?php echo e(route('grades.unlock', $group->id)); ?>" class="btn btn-outline-secondary btn-sm w-100 fw-bold">Unlock Grading</button>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </form>
                                </div>
...
<div class="modal fade" id="addMemberModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 500px !important;">
        <form action="<?php echo e(route('groups.members.store')); ?>" method="POST" id="addMemberForm" class="w-100">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="group_id" value="<?php echo e($group->id); ?>">
                ...
                <div class="modal-body p-4" style="max-height: 65vh; overflow-y: auto;">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="suggestionsList">
                            <?php $__empty_1 = true; $__currentLoopData = $eligibleStudents ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="suggestion-item p-2 border rounded mb-2 d-flex align-items-center justify-content-between cursor-pointer" 
                                 onclick="selectUser(this, <?php echo e($student->id); ?>)">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="user-avatar rounded-circle" style="width: 40px; height: 40px; background-image: url('<?php echo e($student->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($student->name).'&background=random'); ?>'); background-size: cover;"></div>
                                    <div>
                                        <div class="fw-bold small student-name"><?php echo e($student->name); ?></div>
                                        <div class="text-muted small student-email" style="font-size: 0.75rem;"><?php echo e($student->email); ?></div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-2">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h3 class="section-title text-muted small fw-bold text-uppercase mb-0">Current Members (<?php echo e($group->members->count()); ?>)</h3>
                        </div>
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div class="member-item p-2 rounded d-flex align-items-center justify-content-between hover-bg-light">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="user-avatar rounded-circle" style="width: 36px; height: 36px; background-image: url('<?php echo e($member->avatar_url ?? 'https://ui-avatars.com/api/?name='.urlencode($member->name).'&background=random'); ?>'); background-size: cover;"></div>
                                    <div>
                                        <div class="fw-medium small"><?php echo e($member->name); ?></div>
                                        <div class="text-muted small" style="font-size: 0.75rem;"><?php echo e($member->email); ?></div>
                                    </div>
                                </div>
                                <span class="badge bg-light text-secondary border"><?php echo e($member->pivot->role); ?></span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<script>
    ...
    searchInput.addEventListener('input', function(e) {
        ...
        searchTimeout = setTimeout(async () => {
             try {
                 const response = await fetch(`<?php echo e(route('groups.candidates', $group->id)); ?>?q=${encodeURIComponent(term)}`);
...
<div class="modal fade" id="createListModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('lists.store')); ?>" method="POST" class="w-100">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="group_id" value="<?php echo e($group->id); ?>">
            <div class="modal-content">
                <div class="modal-header">
...
<div class="modal fade" id="createCardModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('cards.store')); ?>" method="POST" class="w-100">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="col-sm-6 col-md-3">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu shadow-sm border-0">
                                ...
                                <?php $__currentLoopData = $group->members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <li><a class="dropdown-item d-flex align-items-center gap-2" href="#" onclick="updateAssignee(<?php echo e($member->id); ?>, '<?php echo e($member->name); ?>', '<?php echo e($member->avatar_url); ?>')">
                                      <img src="<?php echo e($member->avatar_url); ?>" class="rounded-circle" width="20" height="20">
                                      <span class="small"><?php echo e($member->name); ?></span>
                                 </a></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
    ...
    async function saveNewSubtask() {
        ...
        try {
            const response = await fetch('/checklists', {
                ...
                body: JSON.stringify({ card_id: currentCard.id, name: name, _token: '<?php echo e(csrf_token()); ?>' })
            });
    ...
    async function updateChecklistName(id, name) {
        try {
            await fetch(`/checklists/${id}`, {
                ...
                body: JSON.stringify({ name: name, _method: 'PUT', _token: '<?php echo e(csrf_token()); ?>' })
            });
        } catch(e) { console.error(e); }
    }
    ...
    async function deleteChecklist(id) {
        ...
        try {
            const response = await fetch(`/checklists/${id}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' },
                body: JSON.stringify({ _method: 'DELETE', _token: '<?php echo e(csrf_token()); ?>' })
            });
    ...
    async function saveChecklistItem() {
        ...
        try {
            const response = await fetch('/checklist-items', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' },
                body: JSON.stringify({ checklist_id: checklistId, name: name, _token: '<?php echo e(csrf_token()); ?>' })
            });
            const data = await response.json();
    ...
    async function toggleItem(id, checked) {
        try {
            ...
            await fetch(`/checklist-items/${id}`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                body: JSON.stringify({ is_checked: checked, _method: 'PUT', _token: '<?php echo e(csrf_token()); ?>' })
            });
        } catch(e) { console.error(e); }
    }
    ...
    async function saveListOrder() {
        ...
        try {
            await fetch('/lists/reorder', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'Accept': 'application/json' },
                body: JSON.stringify({ lists: listIds, _token: '<?php echo e(csrf_token()); ?>' })
            });
...
<?php echo $__env->make('layouts.student_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/groups/show.blade.php ENDPATH**/ ?>