        ...
        <form action="<?php echo e(route('classes.index')); ?>" method="GET" class="row g-2 align-items-center mb-0">
            ...
            <div class="col-md-8">
                <div class="search-container">
                    ...
                    <input type="text" name="search" value="<?php echo e(request('search')); ?>" class="form-control form-control-lg border-0 search-input" placeholder="Search by class name, code...">
                </div>
            </div>
            <div class="col-md-4 d-flex align-items-center gap-2 ps-md-4 border-start">
                 <select name="semester" class="form-select border-0 fw-bold bg-transparent shadow-none" onchange="this.form.submit()">
                    ...
                    <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($semester); ?>" <?php echo e(request('semester') == $semester ? 'selected' : ''); ?>><?php echo e($semester); ?></option>
                    ...
                    <div class="row text-center g-2 my-4">
                        <div class="col-6">
                            <div class="bg-light p-3 rounded-3 border">
                                <h4 class="fw-bold mb-0"><?php echo e($class->students_count); ?></h4>
                                <small class="text-muted fw-bold" style="font-size: 10px;">STUDENTS</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="bg-light p-3 rounded-3 border">
                                <h4 class="fw-bold mb-0"><?php echo e($class->groups_count); ?></h4>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
         <div class="col-12">
            <div class="text-center py-5 bg-white border border-dashed rounded-3">
                ...
                <a href="<?php echo e(route('classes.create')); ?>" class="btn btn-primary-custom">
                    Create Class
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.lecturer_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\LaravelProjects\resources\views/classes/lecturer_index.blade.php ENDPATH**/ ?>